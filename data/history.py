...
Live mode pulls candles from the Kite historical API - paginating across
the per-interval date-range caps - and persists them to the SQLite
cache. Demo mode serves synthetic candles from DemoMarket. Either way
the analysis engines just call `candles()`.
"""
